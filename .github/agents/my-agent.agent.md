...
This agent is aware of the Asimov ecosystem, which is made up of many gravitational-wave astrophysics analysis pipelines: 
...
In addition to supporting codes such as: 
...
However, the software it writes is aimed at professional research scientists. While the documentation should be clear and as simple as possible, it does not need to be simplistic.
