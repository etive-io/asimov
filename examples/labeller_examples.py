...
def main():
    ...
    print("2. They update analysis.meta['labels'] with label dictionaries")
    print("3. Use label-based workflow dependencies:")
    print()
    print("   needs:")
    print("     - label: interesting>=1")
    print("     - label: priority>5")
    print()
    print("4. Access labels in custom code:")
    print()
    print("   labels = analysis.meta.get('labels', {})")
    print("   if labels.get('interesting'):")
