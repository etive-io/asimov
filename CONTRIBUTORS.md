...
- **Daniel Williams** ([@transientlunatic](https://github.com/transientlunatic)) - Original author and primary maintainer
...
1. Add your name above in alphabetical order by last name
2. Include your GitHub username if you have one
3. Optionally include areas of contribution
-->
...
We welcome new contributors! See our [Contributing Guide](CONTRIBUTING.rst) for information on how to get involved.
